...
class WeaTher extends React.Component {
    ...
    createMap = element => {
        ...
        this.props.mapWeather.WeathereMap().then((rawData) => {
            var directionMap = {};

            var weatherIcons = {
				'Showers': 'http://www.popodv.com/images/data/weather/showers_128.png',
				'Sunny': 'http://www.popodv.com/images/data/weather/sunny_128.png',
				'Cloudy': 'http://www.popodv.com/images/data/weather/cloudy_128.png'
			};
            ...
            var data = echarts.util.map(rawData.data.data, function (entry) {
                return [entry.time, entry.windSpeed, entry.R, entry.waveHeight];
            });
            var weatherData = echarts.util.map(rawData.data.forecast, function (entry) {
    ...
    render() {
        return (
            <div>
                <div style={{ width: '100%', height: '360px' }}  ref={this.setMapElement}></div>
            </div>
        )
    }
}
